...
public class PackageUtil {
	...
	public static String getApplicationMetaData(String name){
		...
		String value = null;
		try {
			appInfo = BaseApplication.getContext().getPackageManager().getApplicationInfo(BaseApplication.getContext().getPackageName(),PackageManager.GET_META_DATA);
